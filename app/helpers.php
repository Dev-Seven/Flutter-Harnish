...
CONST ADMIN_ROLE = 1;
CONST API_ROLE = 2;
CONST USER_ROLE = 3; // User
CONST SALON_ROLE = 4; // salon owner
CONST STYLIST_ROLE = 5; // Stylist

CONST APPOINTMENT_CREATE = 1;
CONST APPOINTMENT_ACCEPT = 2;
CONST APPOINTMENT_INPROGRESS = 3;
CONST APPOINTMENT_COMPLETE = 4;
CONST APPOINTMENT_CANCEL = 5;
CONST APPOINTMENT_REJECT = 6;
