...
class _SalonDetailScreenState extends State<SalonDetailScreen> {
  ...
  void initState() {
    ...
    print("Salon Detail : ${widget.salonID}");
    print("STylist Detail : ${widget.stylistID}");
    getSalonDetail();
    getCurrentdate();
  }
  ...
  onCheckOutTap() {
    ...
    String stylist = widget.stylistID;
    ...
    if (isServiceAdd == true) {
      ...
      print("PACKAGE LSIT LIST : $checkPackageList");
      print("SERVICE ADD : $isServiceAdd");
      print("SALON ID : ${widget.salonID}");
      print("BOOKING DATE : $date");
      print("BOOKING TIME : $selectedTime");
